Shader "Ut/Lit"
{
    ...
    Properties
    {
        ...
        [Toggle] _CharacterMainLight("CharacterMainLight",Float) = 0
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/UT/Shaders/URP/Lib/Ut-LitInput.hlsl"
            //#include "Packages/com.unity.render-pipelines.universal/Shaders/LitForwardPass.hlsl"
            #include "Assets/UT/Shaders/URP/Lib/Ut-LitForwardPass.hlsl"
            ENDHLSL
        }
...
//            #pragma fragment ShadowPassFragment // we only need to do Clip(), no need color shading
//            
