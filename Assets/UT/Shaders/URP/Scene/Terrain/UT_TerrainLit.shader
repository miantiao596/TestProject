Shader "URP/MoleGame/Scene/TerrainLit"
{
    Properties
    {
        ...
        [SubToggle(GroupSurfaceOptions,_)] _EnableInstancedPerPixelNormal("Enable Instanced per-pixel normal", Float) = 1.0
        ...
        [HideInInspector]_WeightMapNum("WeightMapNum", int) = 0
        [HideInInspector]_WeightMap1("WeightMap1", 2D) = "black" {}
        [HideInInspector]_WeightMap2("WeightMap2", 2D) = "black" {}
        [HideInInspector]_WeightMap3("WeightMap3", 2D) = "black" {}
        [HideInInspector]_WeightMap4("WeightMap4", 2D) = "black" {}
        ...
        [Sub(GroupSeaGrassShadowOptions)]_SeaGrassBound("草海范围(X:MinX Y:MinY Z:MaxX W:MaxY)(SeaGrass Bound)(工具生成)", Vector) = (0,0,1,1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local _ _TERRAINLAYERNUM_DEBUG//地形图层数量debug
            
            #include "UT_TerrainLitInput.hlsl"
            #include "UT_TerrainLitPasses.hlsl"
            ENDHLSL
        }
    ...
    Dependency "AddPassShader" = "URP/MoleGame/Scene/TerrainLit (Add Pass)"
    Dependency "BaseMapShader" = "URP/MoleGame/Scene/TerrainLit (Base Pass)"
