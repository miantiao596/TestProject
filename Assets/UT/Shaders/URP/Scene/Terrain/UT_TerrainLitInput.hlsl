#ifndef UT_TERRAIN_LIT_INPUT_INCLUDED
#define UT_TERRAIN_LIT_INPUT_INCLUDED
...
int _WeightMapNum;
TEXTURE2D(_WeightMap1);       SAMPLER(sampler_WeightMap1);
TEXTURE2D(_WeightMap2);       
TEXTURE2D(_WeightMap3);       
TEXTURE2D(_WeightMap4);       
