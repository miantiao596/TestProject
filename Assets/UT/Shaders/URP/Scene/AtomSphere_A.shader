Shader "URP/MoleGame/Scene/AtomSphere_A"
{
	Properties
	{
		...
		[RGBAChannelMaskToVec4]_MaskTex_ChannelMask("Mask Texture Channel Mask (Default: RGBA)", Vector) = (1,1,1,1)
		...
		[RGBAChannelMaskToVec4]_MaskTex2_ChannelMask("Mask Texture2 Channel Mask (Default: RGBA)", Vector) = (1,1,1,1)
