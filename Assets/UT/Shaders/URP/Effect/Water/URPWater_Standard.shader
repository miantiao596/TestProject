...
Shader "URP/MoleGame/Effects/Water"
{
	Properties
	{
		//[Header(Refraction)]
	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "URPWaterFog.hlsl"  
			#include "URPWaterVariables.hlsl"  
			#include "URPWaterHelpers.hlsl"  
			#include "URPWaterLighting.hlsl"
			#include "URPWaterScattering.hlsl"
			#include "URPWaterRefraction.hlsl"
			#include "URPWaterReflections.hlsl" 
			#include "URPWaterNormals.hlsl"
			#include "URPWaterFoam.hlsl"
			#include "URPWaterAlpha.hlsl"
			#include "URPWaterWave.hlsl"
			#include "URPWaterDynamic.hlsl"
			#include "URPWaterCommon.hlsl"  
