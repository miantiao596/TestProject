   ...
   public class DiffusionProfile : IEquatable<DiffusionProfile>
    ...
    public partial class DiffusionProfileSettings : ScriptableObject
    {
        ...
        public Color scatteringDistance
        {
            ...
            set
            {
                ConvertHDRColorToLDR(value, out profile.scatteringDistance, out profile.scatteringDistanceMultiplier);
                profile.Validate(); UpdateCache();
            }
        }

        void ConvertHDRColorToLDR(Color hdr, out Color ldr, out float intensity)
        {
