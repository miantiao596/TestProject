...
namespace UnityEditor.Rendering.Universal
{
    ...
    partial class DiffusionProfileSettingsEditor : Editor
    {
        ...
        void DrawScattering(bool multipleObjectSelected)
        {
            ...
            {
                using (new MixedValueScope(m_SerializedDiffusionProfileSettings.scatteringDistance.hasMultipleDifferentValues))
        ...
        void DrawTransmission()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                using (new MixedValueScope(transmissionModeMixedValues))
                using (var changeCheckScope = new EditorGUI.ChangeCheckScope())
                {
        ...
        void RenderPreview()
        {
            ...
            m_ProfileMaterial.SetFloat(Shader.PropertyToID("_MaxRadius"), radius);
            m_ProfileMaterial.SetVector(Shader.PropertyToID("_ShapeParam"), shape);
            ...
            m_TransmittanceMaterial.SetVector(Shader.PropertyToID("_ShapeParam"), shape);
            m_TransmittanceMaterial.SetVector(Shader.PropertyToID("_TransmissionTint"), obj.transmissionTint);
            m_TransmittanceMaterial.SetVector(Shader.PropertyToID("_ThicknessRemap"), obj.thicknessRemap);
